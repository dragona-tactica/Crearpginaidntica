import svgPaths from "./svg-p6tgz2m91p";
...
function Group() {
  return (
    <div className="absolute contents left-[617px] top-[732px]">
      <div className="absolute bg-[#27423f] h-[38px] left-[617px] rounded-[15px] top-[737px] w-[206px]" />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['FONTSPRING_DEMO_-_Isidora_Sans:Regular',sans-serif] h-[34px] justify-center leading-[0] left-[723px] not-italic text-[32px] text-center text-white top-[749px] w-[162px]">
