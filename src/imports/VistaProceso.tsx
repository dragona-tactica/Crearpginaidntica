...
function Heading() {
  return (
    <div className="absolute contents left-0 top-[-35px]" data-name="Heading">
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[18px] leading-[normal] left-[1220px] not-italic text-[#a0aec0] text-[18px] top-[31px] w-[125px]">Cerrar sesión</p>
      <div className="absolute h-[102px] left-[46px] top-[-35px] w-[171px]" data-name="Mesa de trabajo 4a1 2">
...
function Group1() {
  return (
    <div className="absolute contents left-[1077px] top-[880px]">
      <div className="absolute bg-[#a4def2] h-[67px] left-[1077px] rounded-[15px] top-[880px] w-[285px]" />
      <Group />
    </div>
  );
}
...
export default function VistaProceso() {
  return (
    <div className="bg-[#f8f4e1] relative size-full" data-name="Vista Proceso">
      <Heading />
      ...
      <p className="absolute font-['FONTSPRING_DEMO_-_Isidora_Sans_Alt_Black:Regular',sans-serif] leading-[normal] left-[1700px] not-italic text-[#23444d] text-[48px] top-[357px] whitespace-nowrap">Procesos Abiertos</p>
